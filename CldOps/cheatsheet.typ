...
#image("img/sidecaristio.png", width: 80%)
...
== PromQL Examples
#text(size: 5pt)[
  - *Counter* (`_total`): Braucht `rate(...[5m])`, um Geschwindigkeit pro Sekunde zu berechnen.
  - *Gauge*: Braucht kein `rate()`, da es bereits den aktuellen Zustand darstellt.
]
#block[
  #set text(size: 6pt)
  - *Pods per Namespace*: \
...
#image("img/argocdarch.png", width: 60%)
